<template>
  <div class="chating-room-wrapper">
    <div class="avata-3D">
      <img src="../assets/3d-default.png" />
    </div>
    <div class="chating-room">
      ...
      <div class="conversation-container" ref="chatbox">
        <div class="time">
...
export default {
  ...
  watch: {
    conversation: function () {
      console.log("새 메세지 추가됨");
      // 화면에 추가된 후 동작하도록
      this.$nextTick(() => {
        let conversation = this.$refs.chatbox;
